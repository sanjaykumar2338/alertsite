        ...
        <div class="container flex l-gap flex-mobile lr-m">
            ...
            <div class="page-content pg-l">
                ...
                <div class="accordion-app">
                    <button class="accordion">HEADING NO QA1</button>
                    <div class="panel">{!! $faq->description !!}</div>
                    <button class="accordion">HEADING NO QA2</button>
                    <div class="panel">{!! $faq->description !!}</div>
                    <button class="accordion">HEADING NO QA3</button>
                    <div class="panel">{!! $faq->description !!}</div>
                    <button class="accordion">HEADING NO QA4</button>
                    <div class="panel">{!! $faq->description !!}</div>
                </div>
            </div>
        </div>
